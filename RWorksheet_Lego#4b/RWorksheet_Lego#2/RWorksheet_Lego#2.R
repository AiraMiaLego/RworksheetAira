...
#Only the "first" and "third" element printed as an outpout because this two are the only ones accessed in vector x.
...
#e. e. Display the first six rows and last six rows of the new.RData. 
#What is the R script?
library(readr)
